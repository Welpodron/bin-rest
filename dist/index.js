...
var parser_1 = require("./middlewares/parser");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, sequelize_service_1.SequelizeService.authenticate()];
            case 1:
                _a.sent();
                console.log("Connection has been established successfully.");
                return [4 /*yield*/, sequelize_service_1.SequelizeService.sync()];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                app.use((0, parser_1.queryParser)());
